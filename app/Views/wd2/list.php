...
<div class="p-8 max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-slate-500 mt-1">Kegiatan yang memerlukan persetujuan Wakil Direktur 2.</p>
        </div>
        <div class="bg-white px-4 py-2 rounded-lg border border-slate-200 shadow-sm text-sm">
            ...
            <span class="text-indigo-600 font-mono ml-1"><?php echo count($pengajuan); ?></span>
        </div>
    </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-start gap-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-2">
                            <span class="px-2 py-0.5 bg-indigo-100 text-indigo-700 text-[10px] font-bold uppercase rounded">
                                #<?php echo $row['id']; ?>
                            </span>
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <span class="font-bold text-slate-700 ml-2"><?php echo htmlspecialchars($row['nama_jurusan'] ?? '-'); ?></span>
                            </div>
                            <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="/approval/proses?id=<?php echo $row['id']; ?>" class="px-6 py-2 bg-indigo-600 text-white text-xs font-bold rounded-lg shadow-md hover:bg-indigo-700 hover:-translate-y-0.5 transition-all flex items-center">
