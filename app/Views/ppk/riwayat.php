...
<div class="p-8 max-w-7xl mx-auto">
    <div class="mb-8">
        <a href="/approval" class="text-slate-500 hover:text-violet-600 text-sm flex items-center font-bold transition-colors mb-4">
            <span class="material-icons text-sm mr-1">arrow_back</span> Kembali
        </a>
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Riwayat Persetujuan PPK</h1>
